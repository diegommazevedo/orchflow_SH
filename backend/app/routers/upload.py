...
# /detect é puro (sem banco, sem workspace) — só exige usuário autenticado.
# /contract, /contract/confirm, /sheet, /sheet/confirm exigem workspace.
...
def confirm_sheet(
    ...
    # Valida projeto e isolamento de workspace
    try:
        _pid = uuid.UUID(body.project_id)
    ...
    for t in tasks:
        ...
        status_val = str(t.get("status", "backlog") or "backlog").strip()[:64]
